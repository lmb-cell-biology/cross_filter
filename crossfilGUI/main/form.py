...
class LoadForm(forms.Form):
  ...
  pe = forms.BooleanField(label="Paired-end data")
  ...
  heterozygous = forms.BooleanField(label="Include heterozygous variants")
  ...
  q = forms.BooleanField(label="Silence progress")
  
  log = forms.BooleanField(label="Log progress")
